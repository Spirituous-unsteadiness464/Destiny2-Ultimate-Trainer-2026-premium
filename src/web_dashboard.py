...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-premium.WebDashboard")

class WebDashboard:
    def __init__(self, trainer: Trainer, port=4204):
...
<html>
<head>
    <title>Destiny2-Ultimate-Trainer-2026-premium Dashboard</title>
    <style>
...
<body>
    <h1>Destiny2-Ultimate-Trainer-2026-premium</h1>
    <div id="features"></div>
    <script>
